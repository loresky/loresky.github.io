...
|Path Intellisense|路径自动提示|[进入](https://marketplace.visualstudio.com/items?itemName=christian-kohler.path-intellisense)|
|Mermaid Preview|画流程图|[进入](https://marketplace.visualstudio.com/items?itemName=vstirbu.vscode-mermaid-preview)|
|PlantUML|UML图|[进入](https://marketplace.visualstudio.com/items?itemName=jebbs.plantuml)|
